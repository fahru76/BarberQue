-- Harden reset_operational_state against Supabase safeupdate.
-- The singleton shop_settings row and all staff rows must still be updated,
-- but pg-safeupdate requires an explicit predicate even inside SECURITY DEFINER
-- PL/pgSQL functions.
